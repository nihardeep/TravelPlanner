// CLEAN, FIXED, FULL App.js WITH Search Button onClick FIX + Webhooks + No JSX Errors
...
export default function TravelApp() {
  ...
  const handleChatSubmit = async () => {
    ...
    fetch(
      "https://nihardip.app.n8n.cloud/webhook-test/d7de37ee-3a58-446b-a226-115066a37281",
      {
        method: "POST",
    ...
    try {
      const response = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `You are an expert travel planner specializing in Southeast Asian destinations. Help users plan amazing trips to ${selectedDestination}.`,
            },
            ...messages,
            userMessage,
          ],
      ...
      // Webhook — Send assistant message
      fetch(
        "https://nihardip.app.n8n.cloud/webhook-test/d7de37ee-3a58-446b-a226-115066a37281",
        {
          method: "POST",
